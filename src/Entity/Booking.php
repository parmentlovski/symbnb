...
class Booking
{
     ...
     * Type("DateTime"),(message="Attention, la date d'arrivée doit être au bon format !")
    ...
    /**
     * @ORM\Column(type="datetime")
     * Type("DateTime"),(message="Attention, la date de départ doit être au bon format !")
    ...
    /**
     * Cette fonction va permettre de récuperer un tableau des journées qui correspondent à ma réservation
     *
